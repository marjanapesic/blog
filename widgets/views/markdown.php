	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="addImageModalLabel<?php echo $id?>"><?php echo Yii::t('BlogModule.widgets_views_markdown', 'Add	image/file')?></h4>
			</div>
			<div class="modal-body">
				...
				<div id="addImageModalProgress<?php echo $id?>">
					<strong><?php echo Yii::t('BlogModule.widgets_views_markdown', 'Please wait while uploading....')?></strong>
				</div>

			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo Yii::t('BlogModule.widgets_views_markdown', 'Close')?></button>
			</div>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="addLinkModalLabel<?php echo $id?>"><?php echo Yii::t('BlogModule.widgets_views_markdown', 'Add link')?></h4>
			</div>
			<div class="modal-body">
				<div class="form-group">
					<label for="addLinkTitle"><?php echo Yii::t('BlogModule.widgets_views_markdown', 'Link title')?></label> <input type="text"
						class="form-control" id="addLinkTitle<?php echo $id?>"
						placeholder="Title of your link">
				</div>
				<div class="form-group">
					<label for="addLinkTarget<?php echo $id?>"><?php echo Yii::t('BlogModule.widgets_views_markdown', 'Target')?></label> <input
			...
			<div class="modal-footer">
				...
				<button type="button" id="addLinkButton<?php echo $id?>"
					class="btn btn-primary"><?php echo Yii::t('BlogModule.widgets_views_markdown', 'Add link')?></button>
			</div>
		</div>
	</div>
</div>
